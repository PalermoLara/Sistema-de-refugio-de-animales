...
namespace BLL
{
    public class bllFamilia_941lp
    {
        ...
        public void AltaFamilia_941lp(string nombreFamilia_941lp, List<string> permisosAñadir_941lp)
        {
            ...
            bllBitacoraEvento_941lp.Alta_941lp(sessionManager941lp.Gestor_941lp.RetornarUsuarioSession_941lp().nombreUsuario_941lp, "Gestion familia", "Familia dada de alta", 1);
        }
        ...
        public void EliminarFamilia_941lp(string nombreFamilia_941lp)
        {
            ...
            bllBitacoraEvento_941lp.Alta_941lp(sessionManager941lp.Gestor_941lp.RetornarUsuarioSession_941lp().nombreUsuario_941lp, "Gestion familia", "Familia eliminada", 1);
        }
