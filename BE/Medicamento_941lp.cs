...
namespace BE
{
    ...
    {
        public Medicamento_941lp(string pNumeroOficial_941lp, string pNombreComercial_941lp, string pNombreGenerico_941lp,string pForma_941lp, DateTime pCaducidad_941lp)
        {
