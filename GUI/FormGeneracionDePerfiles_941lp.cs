    ...
    public partial class FormGeneracionDePerfiles_941lp : Form, IObserver_941lp
    {
        ...
        private void btnAplicar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string exception_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_NOMBRE_IGUAL_PERFIL", "Nombre igual al nombre de un perfil");
                if (bllPerfil_941Lp.VerificarNombreDePerfil_941lp(txtCrear.Text)) throw new Exception(exception_941lp);
                string exception1_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_NOMBRE_IGUAL_FAMILIA", "Nombre igual al nombre de una familia");
                if (bllFamilia_941lp.VerificarNombreDeFamilia_941lp(txtCrear.Text)) throw new Exception(exception1_941lp);
                string exception2_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_NOMBRE_IGUAL_PERMISO", "Nombre igual al nombre de una patente");
                ...
                switch (modo_941lp)
                {
                    case ModoOperacion_941lp.Crear:
                        string exception3_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_DATOS_FALTANTES", "Error. Debe ingresar todos los datos");
                        ...
                        if (rbFamilias.Checked)
                        {
                            string exception4_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_FAMILIA_VACIA", "No puede crear una familia vacia");
                    ...
                    case ModoOperacion_941lp.Asignar:
                        if (rbPerfiles.Checked)
                        {
                            string exception5_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_PERMISOS_REPETIDOS", "Permisos repetidos");
                        ...
                        if (rbFamilias.Checked)
                        {
                            string exception6_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_PERMISOS_REPETIDOS", "Permisos repetidos");
        ...
        private void ProcesarNodoSeleccionado(TreeNode nodo_941lp, List<string> lista_941lp, bool esRaiz_941lp)
        {
            if (nodo_941lp.Checked)
            {
                if (esRaiz_941lp)
                {
                    string exception_941lp = TraductorHelper_941lp.TraducirMensaje_941lp("FormGeneracionDePerfiles_941lp", "MSG_NODO_RAIZ_SELECCIONADO", "No se puede seleccionar el nodo raíz.");
        ...
        {
            string url = "https://docs.google.com/document/d/1j5AR3nS1CD2I-xyaW_7rPCf6-4WdFzHvhaq5q_U_rDQ/edit?tab=t.0#heading=h.4fogi0i75wmv";
